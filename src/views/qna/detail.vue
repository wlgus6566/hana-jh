        ...
        <div class="inner">
          <template v-if="answer">
            <form action="#" @submit.prevent="submitAnswer">
              ...
              <div class="area-btn">
                <button type="button" class="btn-line-gray-lg">취소</button>
          ...
          <template v-else>
            ...
            <div class="area-btn">
              ...
              <button type="button" class="btn-primary-lg">답변 등록</button>
            </div>
          </template>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      bullet: {
        list: [
          "최소 30자 ~ 최대 500자까지 입력해주세요.",
          "등록된 답변이 고객의 모바일 화면에서 노출되는 점을 고려하여 답변을 작성해주세요.",
        ],
      },
    };
  },
